...
while True:
    ...
    if class_polygon is None:
        flowbel.ImageUtils.drawText(current_image, (10, 50), "Draw: {}".format(current_class_name), scale=1, padding=5, thickness=1, color=(255,255,255), bg=(0,0,255))
    else:
        flowbel.ImageUtils.drawText(current_image, (10, 50), "{} is OK!".format(current_class_name), scale=1, padding=5, thickness=1, color=(0,0,0), bg=(0,255,0))
...
while(current_index < len(images)):
    ...
    flowbel.ImageUtils.drawText(output, (10, 50), "Frame: {}".format(current_index), scale=1, padding=5, thickness=1, color=(0, 0, 0), bg=(0, 255, 0))
    # output = cv2.polylines(
